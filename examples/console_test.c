...
int main(void) {
    ...
    xTaskCreate(led_task, "LED_blink_1", 128, (void*)&param1, configMAX_PRIORITIES-2, NULL);

    STM_EVAL_LEDInit(LED5);
    xTaskCreate(led_task, "LED_blink_2", 128, (void*)&param2, configMAX_PRIORITIES-2, NULL);

    console_setup();
    xTaskCreate(console_task, "Console", 128, NULL, configMAX_PRIORITIES-1, NULL);
